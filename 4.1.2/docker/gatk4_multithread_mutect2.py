...
def get_args():
    ...
    Loads the parser
    '''
    parser = argparse.ArgumentParser(prog='GATK4.1.2.0 Mutect2 multithreading wrapper.', add_help=True)
...
def prepare_cmd_args(args):
    '''
    prepare GATK4.1.2 Mutect2 cmd based on the python parameters.
...
def main():
    ...
    if any(x != 0 for x in ec):
        print('Failed GATK4.1.2 multithreading Mutect2 calling.')
    else:
        print('Completed.')
